# Contributing to agent-sovereign

Thank you for contributing to agent-sovereign, part of the AumOS portfolio.
...
```bash
git clone https://github.com/aumos-ai/agent-sovereign.git
cd agent-sovereign
pip install -e ".[dev]"
```
