"""Plugin registry for agent-sovereign.
...
class PluginRegistry(Generic[T]):
    ...
    def load_entrypoints(self, group: str) -> None:
        ...
        ----------
        group:
            The entry-point group name, e.g. "agent_sovereign.plugins".
        ...
        Then at runtime::
            ...
            registry.load_entrypoints("agent_sovereign.plugins")
        """
