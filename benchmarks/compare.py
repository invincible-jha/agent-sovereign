"""Comparison visualiser for agent-sovereign benchmark results."""
...
def main() -> None:
    ...
    print(f"\n{'=' * 80}")
    print("  agent-sovereign Benchmark Results")
    print(f"{'=' * 80}")
    ...
    print("    python benchmarks/bench_sovereignty_throughput.py")
    print("    python benchmarks/bench_deployment_latency.py")
